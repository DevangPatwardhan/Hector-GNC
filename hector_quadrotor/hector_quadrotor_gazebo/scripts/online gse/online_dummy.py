...
def main():
    try:
        ...
        loop_vertex = input("Enter goal vertex name: ")
        x3 = float(input("Enter x coordinate for loop vertex: "))
        y3 = float(input("Enter y coordinate for loop vertex: "))
        z3 = float(input("Enter z coordinate for loop vertex: "))
        
        r3 = 0
        g_value3 = 0
        b3 = 1
        a3 = 1
        goal_color = ColorRGBA(r3, g_value3, b3, a3)
        g.add_vertex(loop_vertex, x3, y3, z3, goal_color)
        add_edge_temp(g, marker_pub)
        
        loop2_vertex = input("Enter goal vertex name: ")
        x4 = float(input("Enter x coordinate for loop vertex: "))
        y4 = float(input("Enter y coordinate for loop vertex: "))
        z4 = float(input("Enter z coordinate for loop vertex: "))
        
        r4 = 0
        g_value4 = 0
        b4 = 1
        a4 = 1
        goal_color = ColorRGBA(r4, g_value4, b4, a4)
        g.add_vertex(loop2_vertex, x4, y4, z4, goal_color)
        add_edge_temp(g, marker_pub)
        time.sleep(2)
        
        vertex_to_delete = input("Enter the vertex to delete: ")
