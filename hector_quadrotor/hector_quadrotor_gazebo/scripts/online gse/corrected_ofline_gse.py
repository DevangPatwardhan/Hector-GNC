    ...
    try:
        ...
        while not rospy.is_shutdown():
            ...
            if gi_value==0:
                ...
                nearest_intersected_shape(f,random_point,xobs,gse_sample,g,marker_pub,node_name,xrand)
                ...
                random_point_1 = generate_random_point_in_spherical_sector(last_value[0], phi_a, d_phi, theta_a, d_theta)
                ...
                if gi_value_1==0:
                    ...
                    nearest_intersected_shape(f,random_point_1,xobs,gse_sample,g,marker_pub,node_name,random_point1_list)
