...
def publish_points_and_line(point1, point2):
    ...
    mid_point = Point()
    mid_point = float(point2.x - 0.5)
    mid_point = float(point2.y - 0.5)
    mid_point = point2.z

    # Add the points to the marker
    points_marker.points.append(point1)
    points_marker.points.append(point2)
    points_marker.points.append(mid_point)
    ...
    line_marker.points.append(point1)#!/usr/bin/env python3
...
def publish_points_and_line(point1, point2):
    ...
    moving_point1 = Point()
    moving_point1.x = float(point2.x - 0.5)
    moving_point1.y = point2.y 
    moving_point1.z = point2.z
