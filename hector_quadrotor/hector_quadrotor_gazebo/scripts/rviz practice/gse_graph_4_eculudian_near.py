...
def publish_graph(g, start, goal, shortest_path):
    ...
    for idx, (vertex_name, (x, y, z, color)) in enumerate(g.vertices.items()):
        ...
        # Create a marker for the text slightly above the point
        text_marker = Marker()
        ...
        text_marker.pose.position = Point(x=x, y=y, z=z + 0.1)  # Adjust z coordinate to position above the point
...
def print_euclidean_distances(graph):
