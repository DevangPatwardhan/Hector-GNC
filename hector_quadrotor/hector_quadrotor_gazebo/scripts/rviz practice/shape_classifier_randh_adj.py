...
def publish_marker(point, point2, height, radius):
    ...
    marker.mesh_resource = "file:///home/ros/stl/r_0.5_h-1.stl"  # Assuming this is your mesh resource
    ...
    # Calculate the angle of the cone using arctan formula
...
def calculate_cone_angle(height, radius):
    # Calculate the angle of the cone using arctan formula
    theta = math.atan(height / radius)
    # Convert radians to degrees
    theta_degrees = math.degrees(theta)
...
if __name__ == "__main__":
    ...
    # Get cone dimensions from the user
    ...
    cone_angle = calculate_cone_angle(height, radius)
    #print("Angle of the cone: {:.2f} degrees".format(cone_angle))
