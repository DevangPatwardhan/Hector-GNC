...
class ObstacleDetection:
    ...
    def publish_center_outside(self, marker_array, bbox, marker_id, offset=0.5):
        ...
        return Point(outside_point_x, outside_point_y, outside_point_z)
...
if __name__ == "__main__":
    ...
    rospy.spin()
    latest_point = od.get_latest_outside_point()
    if latest_point:
        print("Outside point (x, y, z): [%.3f, %.3f, %.3f]" % (latest_point.x, latest_point.y, latest_point.z))
