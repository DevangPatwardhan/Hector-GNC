...
class ObstacleDetector:
    ...
    def pointcloud_callback(self, msg):
        ...
        rospy.loginfo(f"Number of points in the original point cloud: {len(points_list)}")
    ...
    def filter_cloud(self, cloud):
        ...
        rospy.loginfo(f"Number of points after downsampling: {len(downsampled_cloud.points)}")
        ...
        rospy.loginfo(f"Number of points after region of interest filtering: {len(cloud_roi.points)}")
    ...
    def segment_ground(self, cloud):
        ...
        rospy.loginfo(f"Number of points in ground cloud: {len(ground_cloud.points)}")
    ...
    def cluster_cloud(self, cloud):
        ...
        rospy.loginfo(f"Number of clusters found: {len(clusters)}")
    ...
    def publish_bounding_boxes(self, boxes):
        ...
        for i, box in enumerate(boxes):
            marker = self.create_marker(box, i)
            marker_array.markers.append(marker)

        self.marker_pub.publish(marker_array)

    def create_marker(self, box, id):
        marker = Marker()
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        # Execute obstacle detection logic
        # Here, the pointcloud_callback method will be invoked automatically by ROS subscribers
        rate.sleep()
