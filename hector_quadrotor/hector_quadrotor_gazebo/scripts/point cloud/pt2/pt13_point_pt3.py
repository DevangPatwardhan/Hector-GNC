...
class ObstacleDetection:
    ...
    def publish_center_outside(self, marker_array, bbox, marker_id, offset=0.5):
        ...
        # Ensuring that the point is clearly outside the bounding box.
        #outside_point_x = (center[0]  / 2.0) + offset
        #outside_point_x = (center[0]  ) + extents[0]
        #outside_point_y = (center[1] ) + extents[1]
        #outside_point_z = (center[2]  / 2.0) + offset

        outside_point_x = (center[0] /1.5) 
        outside_point_y = (center[1]  /1.5  ) 
        outside_point_z = (center[2] / 1.2  ) 

        #outside_point_x = center[0] + extents[0] / 2.0 + offset
        #outside_point_y = center[1] + extents[1] / 2.0 + offset
        #outside_point_z = center[2] + extents[2] / 2.0 + offset
