...
#def add_vertex(graph,x_rand,y_rand,z_rand):
def add_vertex(graph):
    vertex_name = input("Enter vertex name: ")
    #x = x_rand
    #y = y_rand
    #z = z_rand
    x = float(input("Enter x vertex "))
    y = float(input("Enter y vertex "))
    z = float(input("Enter z vertex "))
...
#def add_edge(graph,current_node,xnearest):
def add_edge(graph):
...
if __name__ == "__main__":
    try:
        ...
        while True:
            # Check if the graph is connected fradd_vertex(g)om start to goal
            ...
            #num_vertices = int(input("Enter the number of additional vertices: "))
           ...
           # near=nearest(g, point)
            ...
            #steer(near,point)
            add_vertex(g)
            #num_edges = int(input("Enter the number of additional edges: "))
            #for _ in range(num_edges):
            add_edge(g)
            
            publish_graph(g, start_vertex, goal_vertex, None)
