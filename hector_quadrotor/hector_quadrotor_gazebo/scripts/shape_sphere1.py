...
def generate_cone():
    ...
    while not rospy.is_shutdown():
        ...
        # Set the orientation of the cone to face the x-axis
        cone.pose.orientation = Quaternion(*quaternion_from_euler(0, -pi/2, 0))
        
        cone.scale.x = 1.0
        cone.scale.y = 1.0
        cone.scale.z = 1.0
        cone.color = ColorRGBA(1.0, 0.5, 0.0, 1.0)  # Orange color, adjust as needed
